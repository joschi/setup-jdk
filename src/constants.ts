...
export const INPUT_RELEASE_TYPE = 'release_type';
export const INPUT_OPENJDK_IMPL = 'openjdk_impl';
export const INPUT_HEAP_SIZE = 'heap_size';
export const INPUT_RELEASE = 'release';
